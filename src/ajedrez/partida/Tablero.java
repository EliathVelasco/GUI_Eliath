...
public class Tablero {
    ...
    public boolean hacerMovimientoEnLaLogica(Movimiento movimiento) throws MovimientoInvalido {
        try {
            ...
            throw new MovimientoInvalido("TU madre");
    ...
    public void quitarMovimientosNoAlcanzables(ArrayList<int[]> ints, int j) {
    ...
    public boolean listaDeCoordenadasTieneAlMenosUna(ArrayList<ArrayList<int[]>> listaDeCoordenadas) {
        for (int i = 0; i < listaDeCoordenadas.size(); i++) {
